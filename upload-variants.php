...
<body class="template-color-1 nft-body-connect">
        ...
        <div class="container">
            <div class="row">
                <div class="upload-variant-title-wrapper">
                    ...
                    <p class="text-center s20">Create Your own art and upload it here, you can chosse between uploading a single image or create your collection of art of a especific topic.</p>
                </div>
            </div>
            <div class="row g-5 mt--40">
                <div class="offset-lg-3 col-lg-3 col-md-6 col-12">
                    <div class="upload-variant-wrapper">
                        ...
                        <a href="create.html?Type=single" class="btn btn-primary mt--20">Create Single</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="upload-variant-wrapper">
                        ...
                        <a href="create.html?Type=collection" class="btn btn-primary mt--20">Create Collection</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Start Footer Area -->
    <div class="rn-footer-one rn-section-gap bg-color--1">
        <div class="container">
            <div class="row gx-15">
