        ...
        <div class="container">
            ...
            <div class="row g-5 mt--40">
                <div class="offset-lg-3 col-lg-3 col-md-6 col-12">
                    <div class="upload-variant-wrapper">
                        <div class="variant-preview">
                            <img src="<?php echo $config['urls']['site'] ?>/assets/images/upload-variants/single.jpg" alt="nuron-single">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="upload-variant-wrapper">
                        <div class="variant-preview">
                            <img src="<?php echo $config['urls']['site'] ?>/assets/images/upload-variants/multiple.jpg" alt="nuron-single">
                        </div>
