                    ...
                    <div class="rn-blog" data-toggle="modal" data-target="#exampleModalCenters">
                        <div class="inner">
                            ...
                            <div class="content">
                                ...
                                <h4 class="title"><a href="blog-details.html">More important feature for designer<i class="feather-arrow-up-right"></i></a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="rn-blog" data-toggle="modal" data-target="#exampleModalCenters">
                        <div class="inner">
                            ...
                            <div class="content">
                                ...
                                <h4 class="title"><a href="blog-details.html">Inavalide purpose classes & motivation.<i class="feather-arrow-up-right"></i></a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="rn-blog" data-toggle="modal" data-target="#exampleModalCenters">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="blog-details.html">
                                    <img src="<?php echo $config['dirs']['site'] ?>/assets/images/blog/blog-05.jpg" alt="Personal Portfolio Images">
                                </a>
                            </div>
                            <div class="content">
                                <div class="category-info">
                                ...
                                <h4 class="title"><a href="blog-details.html">Canada is a great fact for NFT's<i class="feather-arrow-up-right"></i></a></h4>
                            </div>
                        </div>
                    </div>
                </div>
